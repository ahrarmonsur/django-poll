...
SECRET_KEY = 'csw_b%ha!86(gg_m3ts^!eu)!c1yx*#l(vu1@@%)+@xa19qolv'
...
# Templates
# Don't know if this works yet. Have to find out
TEMPLATES = [
	{
		'BACKEND': 'django.template.backends.django.DjangoTemplates',
		'DIRS': [os.path.join(BASE_DIR, 'templates')],
                #'DIRS': ["/home/ahrarmonsur/Dropbox/DB_programming/projects/django_poll/mysite/templates"],
